...
- The built-in fix for airships resolving the wrong drawer slot when you click a Functional Storage drawer. The Functional Storage Create & Aero mod now ships the same fix, along with proper Create contraption support for drawers.
