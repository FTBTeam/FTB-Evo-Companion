...
public class ClientboundSableUDPActivationPacketMixin {
    ...
    private EventLoop ftbevolutioncompanion$guardNullChannel(Channel channel, Operation<EventLoop> original) {
    ...
    private void ftbevolutioncompanion$skipWhenNoEventLoop(EventLoop eventLoop, Runnable task, Operation<Void> original) {
        if (eventLoop != null) {
